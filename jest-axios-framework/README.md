...
│   │   ├── httpClient.js
│   │   ├── apiService.js
│   │   └── authService.js      # Сервіс аутентифікації
│   ├── controllers/       # Контролери з валідацією
│   │   ├── baseController.js    # Базовий контролер зі спільною логікою
│   │   ├── userController.js
│   │   ├── postController.js
│   │   └── authController.js
│   ├── config/            # Конфігурація
...
│   ├── login.test.js     # Тести логіну та токенів
│   ├── token-demo-complete.test.js  # Демонстрація роботи з токенами
│   ├── token-storage.json           # Файл зберігання токенів
│   └── token-demo-storage.json      # Файл для демо тестів
├── docs/                  # Документація
...
# Запуск тестів логіну та токенів
npm run test:login
```
